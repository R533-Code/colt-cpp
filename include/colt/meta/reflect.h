...
DECLARE_BUILTIN_TYPE(clt::i8);
DECLARE_BUILTIN_TYPE(clt::u8);
DECLARE_BUILTIN_TYPE(clt::i16);
DECLARE_BUILTIN_TYPE(clt::u16);
DECLARE_BUILTIN_TYPE(clt::i32);
DECLARE_BUILTIN_TYPE(clt::u32);
DECLARE_BUILTIN_TYPE(clt::i64);
DECLARE_BUILTIN_TYPE(clt::u64);
